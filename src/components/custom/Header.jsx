        ...
        <div>
          {user?
              <div className='flex items-center gap-5 mr-3'>
                 ...
                 <Link to={'/my-trips'}><button className='rounded-full border border-black h-7 w-20 hover:bg-amber-600 hover:border-none hover:text-white transition duration-300'> My Trips </button></Link>
